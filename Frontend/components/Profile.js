...
export default function Profile() {
    ...
    const {name,email,mobile,user_role,reg_number,password,cf_password,err,success} = data
  ...
  <div style={{backgroundColor:"white"}}>
    ...
    <center>
    <h1 className="profilefont" style={{color:"#322B5F",fontWeight:"bold"}}>User Profile</h1> </center>
    ...
    {success && showSuccessMsg(success)}
       ...
       <center>
        ...
        <div className="mb-3">
        <label htmlFor="name" className="t-form-label" style={{color:"#322B5F"}}>Name</label>
         <input type="text"
          style={{width:"450px"}} className="t-form-control"
    ...
    <div className="mb-3">
        <label htmlFor="email" className="t-form-label" style={{color:"#322B5F"}}>Email</label>
        <input type="email"
         style={{width:"450px"}} className="t-form-control"
        ...
        <div className="mb-3">
          <label htmlFor="mobile" className="t-form-label" style={{color:"#322B5F"}}>Mobile</label>
            <input type="text"
            style={{width:"450px"}} className="t-form-control"
            name="mobile" id="mobile" defaultValue={user.mobile}
            placeholder="Mobile" onChange={handleChange} 
                    />
      </div>

    <div className="mb-3">
        <label htmlFor="user_role" className="t-form-label" style={{color:"#322B5F"}}>User Role</label>
        <input type="text"
         style={{width:"450px"}} className="t-form-control"
    ...
    <div className="mb-3">
        <label htmlFor="reg_number" className="t-form-label" style={{color:"#322B5F"}}>Register Number</label>
        <input type="text"
         style={{width:"450px"}} className="t-form-control"
        ...
        placeholder="Your reg_number " disabled />
                ...
                <div className="mb-3">
                    <label htmlFor="password" className="t-form-label" style={{color:"#322B5F"}}>New Password</label>
                    <input type="password"
                     style={{width:"450px"}} className="t-form-control"
                ...
                <div className="mb-3">
                    <label htmlFor="cf_password" className="t-form-label" style={{color:"#322B5F"}}>Confirm New Password</label>
                    <input type="password"
                    style={{width:"450px"}} className="t-form-control"
